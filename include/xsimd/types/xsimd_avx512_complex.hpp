    ...
    public:
        ...
        batch(value_type c0, value_type c1, value_type c2, value_type c3,
              ...
              value_type c12, value_type c13, value_type c14, value_type c15)
                : base_type(
                real_batch(c0.real(), c1.real(), c2.real(), c3.real(), c4.real(), c5.real(), c6.real(), c7.real(),
                           c8.real(), c9.real(), c10.real(), c11.real(), c12.real(), c13.real(), c14.real(),
                           c15.real()),
                real_batch(c0.imag(), c1.imag(), c2.imag(), c3.imag(), c4.imag(), c5.imag(), c6.imag(), c7.imag(),
                           c8.imag(), c9.imag(), c10.imag(), c11.imag(), c12.imag(), c13.imag(), c14.imag(),
                           c15.imag())) {
        }
